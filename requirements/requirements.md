...
| ID          | Release | Requirement                                                                                                                                                                                                                                                                                                             |
| ----------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FDW-LIV-001 | v3.0    | Live surveillance shall use a provider-neutral `airspace.v1` contract and exactly the fixed Atlanta, Savannah / Statesboro, and Central Georgia regional presets; arbitrary user-supplied provider coordinates shall not be proxied.                                                                                    |
...
| FDW-EDG-002 | v3.0    | One Durable Object per fixed region shall share at most one in-flight provider poll among connected viewers, poll at the declared cadence only while viewers exist, and avoid scheduling background polling for snapshot-only requests.                               |
| FDW-EDG-003 | v3.0    | Provider access shall enforce an upstream timeout, Retry-After-aware backoff, persisted consecutive-failure state, and a bounded circuit breaker so clients cannot cause upstream request amplification during failure or rate limiting.                              |
...
| ID          | Release | Requirement                                                                                                                                                                                                                                                               |
| ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FDW-LUI-001 | v3.0    | Live Airspace shall become the default application view without removing the existing synthetic Diagnostics Lab, Investigation, Verification, Configuration, or evidence-export capabilities.                                                                             |
